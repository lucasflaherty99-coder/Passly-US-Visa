...
import { getStepPosition, getTotalSteps } from "@/lib/quiz/quizState";
...
export function QuestionCard({
  ...
  const { state } = useQuiz();
  const stepPosition = getStepPosition(step, state.answers);
  const totalSteps = getTotalSteps(state.answers);
